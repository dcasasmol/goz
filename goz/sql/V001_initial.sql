...
CREATE TABLE "dbapi_zone" (
    "id" serial NOT NULL PRIMARY KEY,
    "name" varchar(255) NOT NULL,
    "king_id" varchar(255) NOT NULL REFERENCES "dbapi_user" ("id") DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE "dbapi_venue" (
    ...
    "categorie_id" varchar(255) NOT NULL REFERENCES "dbapi_categorie" ("id") DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE "dbapi_score" (
    "id" varchar(255) NOT NULL PRIMARY KEY,
    "user_id" varchar(255) NOT NULL REFERENCES "dbapi_user" ("id") DEFERRABLE INITIALLY DEFERRED,
    "zone_id" integer NOT NULL REFERENCES "dbapi_zone" ("id") DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE "dbapi_checkin" (
    "id" varchar(255) NOT NULL PRIMARY KEY,
    "user_id" varchar(255) NOT NULL REFERENCES "dbapi_user" ("id") DEFERRABLE INITIALLY DEFERRED,
    "venue_id" varchar(255) NOT NULL REFERENCES "dbapi_venue" ("id") DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE "dbapi_purchase" (
    "id" varchar(255) NOT NULL PRIMARY KEY,
    "user_id" varchar(255) NOT NULL REFERENCES "dbapi_user" ("id") DEFERRABLE INITIALLY DEFERRED,
    "item_id" varchar(255) NOT NULL REFERENCES "dbapi_item" ("id") DEFERRABLE INITIALLY DEFERRED,
    "number" integer CHECK ("number" >= 0) NOT NULL,
    "creation_date" timestamp with time zone NOT NULL,
    "last_update" timestamp with time zone NOT NULL,
...
CREATE TABLE "dbapi_unlocking" (
    "id" varchar(255) NOT NULL PRIMARY KEY,
    "user_id" varchar(255) NOT NULL REFERENCES "dbapi_user" ("id") DEFERRABLE INITIALLY DEFERRED,
    "badge_id" varchar(255) NOT NULL REFERENCES "dbapi_badge" ("id") DEFERRABLE INITIALLY DEFERRED,
    "creation_date" timestamp with time zone NOT NULL,
    "last_update" timestamp with time zone NOT NULL,
...
CREATE TABLE "dbapi_event" (
    ...
    "venues_id" varchar(255) NOT NULL REFERENCES "dbapi_venue" ("id") DEFERRABLE INITIALLY DEFERRED,
    "zones_id" integer NOT NULL REFERENCES "dbapi_zone" ("id") DEFERRABLE INITIALLY DEFERRED,
    "items_id" varchar(255) NOT NULL REFERENCES "dbapi_item" ("id") DEFERRABLE INITIALLY DEFERRED,
    "categories_id" varchar(255) NOT NULL REFERENCES "dbapi_categorie" ("id") DEFERRABLE INITIALLY DEFERRED,
    "users_id" varchar(255) NOT NULL REFERENCES "dbapi_user" ("id") DEFERRABLE INITIALLY DEFERRED,
    "creation_date" timestamp with time zone NOT NULL,
    "last_update" timestamp with time zone NOT NULL
)
;
